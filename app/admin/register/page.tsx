...
export default function AdminRegisterPage() {
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        try {
            ...
            setError(err instanceof Error ? mapFirebaseError(err.message) : "Registrierung fehlgeschlagen.");
        } finally {
            setLoading(false);
        }
    }
        ...
        <main className="min-h-screen flex items-center justify-center bg-[#F7F3EE] px-6">
            <div className="w-full max-w-md bg-white rounded-3xl shadow-sm border border-black/5 p-8">
                <div className="text-center">
                    ...
                    <h1 className="mt-6 text-3xl font-light text-[#0B0B0B]">Admin Registrierung</h1>
                </div>
                ...
                {done ? (
                    <div className="mt-8 text-center space-y-4">
                        ...
                        <p className="text-gray-700">
                            Deine Registrierung ist eingegangen. Ein Owner muss dein Konto
                            freigeben, bevor du dich einloggen kannst.
                        </p>
